...
public class HpplanStatDatFile extends AbstractDatFile {
    ...
    @Entry(position = 2, name = "T", conType = ContentType.SINGLE, numType = NumericalType.INTEGER)
    private DatEntry<SingleContent> t;

    @Entry(position = 3, name = "ZMax", conType = ContentType.SINGLE, numType = NumericalType.INTEGER)
    private DatEntry<SingleContent> zMax;

    @Entry(position = 4, name = "f", conType = ContentType.THREE_DIM_FIELD, numType = NumericalType.INTEGER)
    ...
    @Entry(position = 6, name = "h", conType = ContentType.ARRAY, numType = NumericalType.INTEGER)
    private DatEntry<SingleContent> h;

    @Entry(position = 7, name = "b", conType = ContentType.TWO_DIM_FIELD, numType = NumericalType.INTEGER)
    private DatEntry<SingleContent> b;

    @Entry(position = 8, name = "Umax", conType = ContentType.TWO_DIM_FIELD, numType = NumericalType.INTEGER)
    private DatEntry<SingleContent> uMax;

    @Entry(position = 9, name = "u", conType = ContentType.TWO_DIM_FIELD, numType = NumericalType.FLOAT)
    private DatEntry<SingleContent> u;

    @Entry(position = 10, name = "Iinit", conType = ContentType.ARRAY, numType = NumericalType.INTEGER)
