...
public class CLSPMain extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        this.primaryStage.setTitle("Capacitated Lot Sizing Problem");
    ...
    public void initRootLayout() {
        try {
            ...
            loader.setLocation(CLSPMain.class.getResource("view/RootLayout.fxml"));
