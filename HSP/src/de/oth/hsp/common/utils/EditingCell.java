 ...
 * JavaFX TableViews
 */
public class EditingCell extends TableCell<Number, Number> {
     ...
     * @return
     */
    private TableColumn<Number, ?> getNextColumn(boolean forward) {
        List<TableColumn<Number, ?>> columns = new ArrayList<>();
        for (TableColumn<Number, ?> column : getTableView().getColumns()) {
     ...
     * @return
     */
    private List<TableColumn<Number, ?>> getLeaves(TableColumn<Number, ?> root) {
        List<TableColumn<Number, ?>> columns = new ArrayList<>();
        if (root.getColumns().isEmpty()) {
            ...
            for (TableColumn<Number, ?> column : root.getColumns()) {
                columns.addAll(getLeaves(column));
            }
            return columns;
        }
