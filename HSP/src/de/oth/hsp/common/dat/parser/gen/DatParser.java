...
public class DatParser extends Parser {
    ...
    public static final int RULE_datBody = 0, RULE_varDeclaration = 1, RULE_varName = 2, RULE_varValue = 3,
            RULE_singleValue = 4, RULE_arrayValue = 5, RULE_oneDimFieldValue = 6, RULE_twoDimFieldValue = 7,
            RULE_threeDimFieldValue = 8;
    public static final String[] ruleNames = { "datBody", "varDeclaration", "varName", "varValue", "singleValue",
            "arrayValue", "oneDimFieldValue", "twoDimFieldValue", "threeDimFieldValue" };
    ...
    public static class VarValueContext extends ParserRuleContext {
        ...
        public OneDimFieldValueContext oneDimFieldValue() {
            return getRuleContext(OneDimFieldValueContext.class, 0);
        }
    ...
    public static class OneDimFieldValueContext extends ParserRuleContext {
        ...
        public OneDimFieldValueContext(ParserRuleContext parent, int invokingState) {
            super(parent, invokingState);
        }

        @Override
        public int getRuleIndex() {
            return RULE_oneDimFieldValue;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof DatListener)
                ((DatListener) listener).enterOneDimFieldValue(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof DatListener)
                ((DatListener) listener).exitOneDimFieldValue(this);
        }
    }

    public final OneDimFieldValueContext oneDimFieldValue() throws RecognitionException {
        OneDimFieldValueContext _localctx = new OneDimFieldValueContext(_ctx, getState());
        enterRule(_localctx, 12, RULE_oneDimFieldValue);
        int _la;
        try {
            enterOuterAlt(_localctx, 1);
            {
    ...
    public final TwoDimFieldValueContext twoDimFieldValue() throws RecognitionException {
        ...
        enterRule(_localctx, 14, RULE_twoDimFieldValue);
        int _la;
        try {
            enterOuterAlt(_localctx, 1);
            {
    ...
    public final ThreeDimFieldValueContext threeDimFieldValue() throws RecognitionException {
        ...
        enterRule(_localctx, 16, RULE_threeDimFieldValue);
        int _la;
        try {
            enterOuterAlt(_localctx, 1);
            {
    ...
    public static final String _serializedATN = "\3\u0430\ud6d1\u8206\uad2d\u4417\uaef1\u8d80\uaadd\3\17X\4\2\t\2\4\3\t"
            + "\3\4\4\t\4\4\5\t\5\4\6\t\6\4\7\t\7\4\b\t\b\4\t\t\t\4\n\t\n\3\2\7\2\26"
            + "\n\2\f\2\16\2\31\13\2\3\2\3\2\3\3\3\3\3\3\3\3\3\3\3\4\3\4\3\5\3\5\3\5"
            + "\3\5\3\5\5\5)\n\5\3\6\3\6\3\7\3\7\3\7\5\7\60\n\7\7\7\62\n\7\f\7\16\7\65"
            + "\13\7\3\7\3\7\3\7\3\b\3\b\3\b\3\b\6\b>\n\b\r\b\16\b?\3\b\3\b\3\t\3\t\3"
            + "\t\3\t\6\tH\n\t\r\t\16\tI\3\t\3\t\3\n\3\n\3\n\3\n\6\nR\n\n\r\n\16\nS\3"
            + "\n\3\n\3\n\2\2\13\2\4\6\b\n\f\16\20\22\2\3\3\2\f\rX\2\27\3\2\2\2\4\34"
            + "\3\2\2\2\6!\3\2\2\2\b(\3\2\2\2\n*\3\2\2\2\f,\3\2\2\2\169\3\2\2\2\20C\3"
            + "\2\2\2\22M\3\2\2\2\24\26\5\4\3\2\25\24\3\2\2\2\26\31\3\2\2\2\27\25\3\2"
            + "\2\2\27\30\3\2\2\2\30\32\3\2\2\2\31\27\3\2\2\2\32\33\7\2\2\3\33\3\3\2"
            + "\2\2\34\35\5\6\4\2\35\36\7\3\2\2\36\37\5\b\5\2\37 \7\5\2\2 \5\3\2\2\2"
            + "!\"\7\13\2\2\"\7\3\2\2\2#)\5\n\6\2$)\5\f\7\2%)\5\16\b\2&)\5\20\t\2\')"
            + "\5\22\n\2(#\3\2\2\2($\3\2\2\2(%\3\2\2\2(&\3\2\2\2(\'\3\2\2\2)\t\3\2\2"
            + "\2*+\t\2\2\2+\13\3\2\2\2,\63\7\7\2\2-/\5\n\6\2.\60\7\4\2\2/.\3\2\2\2/"
            + "\60\3\2\2\2\60\62\3\2\2\2\61-\3\2\2\2\62\65\3\2\2\2\63\61\3\2\2\2\63\64"
            + "\3\2\2\2\64\66\3\2\2\2\65\63\3\2\2\2\66\67\5\n\6\2\678\7\b\2\28\r\3\2"
            + "\2\29=\7\t\2\2:;\7\f\2\2;<\7\6\2\2<>\5\n\6\2=:\3\2\2\2>?\3\2\2\2?=\3\2"
            + "\2\2?@\3\2\2\2@A\3\2\2\2AB\7\n\2\2B\17\3\2\2\2CG\7\t\2\2DE\7\f\2\2EF\7"
            + "\6\2\2FH\5\f\7\2GD\3\2\2\2HI\3\2\2\2IG\3\2\2\2IJ\3\2\2\2JK\3\2\2\2KL\7"
            + "\n\2\2L\21\3\2\2\2MQ\7\t\2\2NO\7\f\2\2OP\7\6\2\2PR\5\20\t\2QN\3\2\2\2"
            + "RS\3\2\2\2SQ\3\2\2\2ST\3\2\2\2TU\3\2\2\2UV\7\n\2\2V\23\3\2\2\2\t\27(/" + "\63?IS";
