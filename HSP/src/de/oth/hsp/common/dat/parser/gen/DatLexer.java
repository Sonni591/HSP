...
public class DatLexer extends Lexer {
    ...
    public static final String[] ruleNames = { "ASSIGN", "COMMA", "SEMI", "COLON", "LARRAY", "RARRAY", "LFIELD",
            "RFIELD", "Identifier", "IntegerLiteral", "FloatingPointLiteral", "Character", "Letter", "DecimalValue",
            "Digit", "NonZeroDigit", "WS", "COMMENT" };
    ...
    public static final String _serializedATN = "\3\u0430\ud6d1\u8206\uad2d\u4417\uaef1\u8d80\uaadd\2\17x\b\1\4\2\t\2\4"
